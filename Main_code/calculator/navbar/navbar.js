            ...
            <li className="list-item-d-1 dropdown-1">
              ...
              <div className="dropdown-content-1">
                <li className="sublist-item-1">
                  <a href="../pomodoro/index.html">POMODOROS</a>
                </li>
                <li className="sublist-item-1">
                  <a className="curr" href="../calculator/index.html">CALCULATOR MEDIE</a>
                </li>
                <li className="sublist-item-1">
      ...
      <li className="list-item-d-2 dropdown-2 text-center">
        ...
        <li className="list-item-d-2 dropdown-2 text-center">
          ...
          <div className="dropdown-content-2 mx-auto">
            <li className="sublist-item-2"><a href="../pomodoro/index.html">POMODOROS</a></li>
            <li className="sublist-item-2"><a className="curr" href="../calculator/index.html">CALCULATOR MEDIE</a></li>
